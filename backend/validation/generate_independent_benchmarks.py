"""
generate_independent_benchmarks.py
==================================

Generates independent (non-circular) benchmark CSV files for Surface and Free-Air
bursts using the official unoptimized references from Swisdak (1994) and UFC 3-340-02.
These are decoupled from the BlastScope solver's optimized continuous polynomials.
"""
...
P0 = 101.325 # kPa (Standard sea-level ambient atmospheric pressure)
C0 = 340.292 # m/s (Speed of sound in air at 15 deg C)

# Official, unoptimized Swisdak (1994) coefficients for hemispherical surface burst
...
# Original, unoptimized Spherical (Free Air) coefficients (literature references)
...
def main():
    ...
    print("Generated independent fig2_15_benchmark.csv (Surface Burst)")
    ...
    print("Generated independent fig2_7_benchmark.csv (Free-Air Burst)")
